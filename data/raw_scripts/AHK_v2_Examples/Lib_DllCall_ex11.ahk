...
#SingleInstance Force ; Source: External Libraries/DllCall_ex11.ah2 Rect := Buffer(16, 0) ; Set capacity to hold four 4-byte integers and initialize them all to zero. ; if 'Rect' is a UTF-16 string, use 'VarSetStrCapacity(&Rect, 16)' and replace all instances of 'Rect.Ptr' with 'StrPtr(Rect)'
