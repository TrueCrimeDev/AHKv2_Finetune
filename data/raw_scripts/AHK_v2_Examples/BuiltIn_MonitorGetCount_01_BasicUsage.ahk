...
Example3_MonitorIterator() {
    ...
    Loop MonCount {
        ...
        lv.Add("", MonNum, Left, Top, Right, Bottom, Width, Height, Format("{:,}", Area), Type)
    }
...
Example7_InformationPanel() {
    ...
    info .= "`nIteration Example:`n"
    info .= "  Loop " MonCount " {`n"
    info .= "    MonNum := A_Index`n"
    info .= "    ; Process monitor #MonNum`n"
    info .= "  }`n"
